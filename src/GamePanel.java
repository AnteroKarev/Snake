...
public class GamePanel extends  JPanel implements ActionListener{
	...
	public void gameOver(Graphics g) {
		...
		g.drawString("Press SPACE to restart", (SCREEN_WIDTH - metrics3.stringWidth("Press SPACE to restart"))/2, SCREEN_HEIGH/2 + UNIT_SIZE*10);
		...
		public void keyPressed(KeyEvent e) {
			switch(e.getKeyCode()) {
				...
				case KeyEvent.VK_SPACE:
					if (!running) {
						try {
							Desktop.getDesktop().open(new File("C:/Users/User/Documents/Programming/Java/Eclipse/Snake/Snake.jar"));
						} catch(IOException p){
